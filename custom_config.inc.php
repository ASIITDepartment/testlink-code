...
$tlCfg->authentication['ldap'][1]['ldap_server'] = '10.10.100.20';
$tlCfg->authentication['ldap'][1]['ldap_port'] = '389';
$tlCfg->authentication['ldap'][1]['ldap_version'] = '3';
$tlCfg->authentication['ldap'][1]['ldap_root_dn'] = 'DC=DOMAIN,DC=LOCAL';
$tlCfg->authentication['ldap'][1]['ldap_uid_field'] = 'sAMAccountName';
$tlCfg->authentication['ldap'][1]['ldap_bind_dn'] = 'ServiceAdmin';
$tlCfg->authentication['ldap'][1]['ldap_bind_passwd'] = '07 Service )&';
$tlCfg->user_self_signup = FALSE;
$tlCfg->authentication['ldap'][1]['ldap_automatic_user_creation'] = FALSE;
...
$g_smtp_username    = 'Mail.Man@asirobots.com';  # user  
$g_smtp_password    = 'Robot$16';  # password
$g_smtp_port = '587';
