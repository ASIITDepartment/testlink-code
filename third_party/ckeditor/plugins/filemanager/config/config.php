...
$config = array(
    ...
    */
    // // 'upload_dir' => '/source/',
    'upload_dir' => '/third_party/asiUserFiles/files/',
    /*
    |--------------------------------------------------------------------------
    ...
    */
    // // 'current_path' => '../source/',
    'current_path' => '../../../asiUserFiles/files/',
    /*
    |--------------------------------------------------------------------------
    ...
    */
    ...
    'thumbs_base_path' => '../../../asiUserFiles/thumbs/',
    /*
    |--------------------------------------------------------------------------
    ...
    */
    ...
    'thumbs_upload_dir' => 'third_party/asiUserFiles/thumbs/',
    /*
    |--------------------------------------------------------------------------
    ...
    */
    ...
    'ext_misc'                                => array( 'gml', 'kml', 'shp', 'yaml', 'dxf', 'geojson', 'json', 'zip', 'rar', 'gz', 'tar', 'iso', 'dmg' ), //Archives
